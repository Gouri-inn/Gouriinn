...
const Footer = () => {
  return (
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm font-semibold text-font_footer">
            Gouri Inn, also known as Guri Inn or Gouri-Inn, offers a luxurious stay in Amravati. Experience elegance,
            comfort, and great service at our premium hotel.
          </p>
        </div>
    ...
    frameBorder="0"
    style={{ border: 0 }}
    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyB1diwHUik-NSeUlgnXqhqOl_-i_2yJzoU&q=Gouri+Inn+Hotel+Amravati"
    allowFullScreen
  ></iframe>
          </div>
        </div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-sm text-gray-400">
        <p>Developed by: Om Bhaulal Patil, Sai .D. Bisare</p>
        <p>Phone: 8799866811</p>
